...
export default function AndroidAppBanner({ locale }: AndroidAppBannerProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-4 rounded-2xl shadow-lg mb-6 animate-slide-up">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <a
            ...
            className="flex items-center space-x-2 bg-white text-green-700 hover:bg-green-50 px-4 py-2 rounded-lg font-semibold transition-colors"
          >
